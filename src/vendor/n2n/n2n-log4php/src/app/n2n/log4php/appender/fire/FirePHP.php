<?php
namespace n2n\log4php\appender\fire;
/**
...
class FirePHP extends \n2n\log4php\LoggerAppender {
	...
	public function append(\n2n\log4php\logging\LoggingEvent $event) {
		...
		switch ($event->getLevel()->toInt()) {
			case \n2n\log4php\LoggerLevel::TRACE:
			case \n2n\log4php\LoggerLevel::DEBUG:
				$this->console->log($msg);
				break;
			case \n2n\log4php\LoggerLevel::INFO:
				$this->console->info($msg);
				break;
			case \n2n\log4php\LoggerLevel::WARN:
				$this->console->warn($msg);
				break;
			case \n2n\log4php\LoggerLevel::ERROR:
			case \n2n\log4php\LoggerLevel::FATAL:
