...
class LoggingEvent {
	...
	*/
	...
	/** 
	* @var \n2n\log4php\location\LocationInfo Location information for the caller. 
	*/
	private $locationInfo;
	
	/**
	 * @var \n2n\log4php\throwable\ThrowableInformation log4php internal representation of throwable
	 */
	...
	* @param mixed $logger The {@link \n2n\log4php\Logger} category of this event or the logger name.
	* @param \n2n\log4php\LoggerLevel $level The level of this event.
	...
	*/
	public function __construct($fqcn, $logger, \n2n\log4php\LoggerLevel $level, $message, $timeStamp = null, $throwable = null) {
		$this->fqcn = $fqcn;
		if($logger instanceof \n2n\log4php\Logger) {
			$this->logger = $logger;
		...
		if ($throwable !== null && $throwable instanceof \Exception) {
			$this->throwableInfo = new \n2n\log4php\throwable\ThrowableInformation($throwable);
		}
	}
	 ...
	 * thread or even on a different machine. The {@link \n2n\log4php\LoggerNDC::get()} method
	...
	/**
	 * @return mixed \n2n\log4php\throwable\ThrowableInformation
	 */
