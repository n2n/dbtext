...
class FilterCriteriaConstraint implements CriteriaConstraint {
	...
	public function __construct(ComparatorConstraint $selectorConstraint) {
		$this->comparatorConstraint = $selectorConstraint;
	}
			
	public function applyToCriteria(Criteria $criteria, CriteriaProperty $alias) {
		$this->comparatorConstraint->applyToCriteriaComparator($criteria->where()->andGroup(), $alias, true);
	}
}
