<?php
namespace n2n\log4php\filter\level;
/**
 ...
 * {@link \n2n\log4php\logging\LoggingEvent}, then the {@link decide()} method returns 
 * {@link \n2n\log4php\LoggerFilter::ACCEPT} in case the <b><var>AcceptOnMatch</var></b> 
 * option value is set to <i>true</i>, if it is <i>false</i> then 
 * {@link \n2n\log4php\LoggerFilter::DENY} is returned. If there is no match, 
 * {@link \n2n\log4php\LoggerFilter::NEUTRAL} is returned.</p>
 * 
 * <p>
...
class LevelMatch extends \n2n\log4php\LoggerFilter {
	...
	public function decide(\n2n\log4php\logging\LoggingEvent $event) {
		if($this->levelToMatch === null) {
			return \n2n\log4php\LoggerFilter::NEUTRAL;
		}
		
		if($this->levelToMatch->equals($event->getLevel())) {	
			return $this->acceptOnMatch ? \n2n\log4php\LoggerFilter::ACCEPT : \n2n\log4php\LoggerFilter::DENY;
		} else {
			return \n2n\log4php\LoggerFilter::NEUTRAL;
		}
	}
