...
class AnnoDispDateTimeArray implements PropertyAnnotation, MethodAnnotation {
	...
	public function __construct($dateStyle = null, $timeStyle = null, $useArrayObject = null) {
	...
	public function getSimpleFormat() {
		return $this->simpleFormat;
	}
	
	public function setSimpleFormat($simpleFormat) {
