 ...
 * @subpackage layouts
 * 
 * @deprecated \n2n\log4php\LoggerLayout TTCC is deprecated and will be removed in a future release. Please use 
 *   LoggerLayoutPattern instead. 
 */
class LayoutTTCC extends \n2n\log4php\LoggerLayout {
	...
	public function __construct($dateFormat = '') {
		$this->warn("\n2n\log4php\LoggerLayout TTCC is deprecated and will be removed in a future release. Please use \n2n\log4php\LoggerLayoutPattern instead.");
		if (!empty($dateFormat)) {
