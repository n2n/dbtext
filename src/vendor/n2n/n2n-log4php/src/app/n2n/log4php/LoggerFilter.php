 ...
 * decide(\n2n\log4php\logging\LoggingEvent)} method of each filter is called sequentially,
 ...
 * @package log4php
 */
abstract class LoggerFilter extends \n2n\log4php\LoggerConfigurable {
	...
	*/
	 ...
	 * the chain.
	 *
	 * @param \n2n\log4php\logging\LoggingEvent $event The {@link \n2n\log4php\logging\LoggingEvent} to decide upon.
