 ...
 * \n2n\log4php\Logger can have. From log4j website:
 * 
...
class LoggerHierarchy {
	 ...
	 * @var \n2n\log4php\renderer\RendererMap 
	 */
	 ...
	 * @param \n2n\log4php\LoggerRoot $root The root logger.
	 */
	public function __construct(\n2n\log4php\LoggerRoot $root) {
		$this->root = $root;
		$this->setThreshold(\n2n\log4php\LoggerLevel::getLevelAll());
		$this->rendererMap = new \n2n\log4php\renderer\RendererMap();
	}
	 ...
	 * @param \n2n\log4php\LoggerLevel $l
	 */
	public function setThreshold(\n2n\log4php\LoggerLevel $threshold) {
	...
	private function printHierarchyInner(\n2n\log4php\Logger $current, $level) {
		for ($i = 0; $i < $level; $i++) {
			echo ($i == $level - 1) ? "|--" : "|  ";
		}
