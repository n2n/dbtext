 ...
 * @package log4php
 */
abstract class LoggerAppender extends \n2n\log4php\LoggerConfigurable {
	...
	public function getDefaultLayout() {
		return new \n2n\log4php\layout\LayoutSimple();
	}
	
	/**
	 * Adds a filter to the end of the filter chain.
	 * @param \n2n\log4php\LoggerFilter $filter add a new \n2n\log4php\LoggerFilter
	 */
	...
	public function doAppend(\n2n\log4php\logging\LoggingEvent $event) {
		...
		while($filter !== null) {
			switch ($filter->decide($event)) {
				case \n2n\log4php\LoggerFilter::DENY: return;
				case \n2n\log4php\LoggerFilter::ACCEPT: return $this->append($event);
				case \n2n\log4php\LoggerFilter::NEUTRAL: $filter = $filter->getNext();
			}
		}
		$this->append($event);
	}	 
